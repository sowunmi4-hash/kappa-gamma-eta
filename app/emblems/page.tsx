    ...
    <main style={{ minHeight:"100vh", background:"#0e0508", color:"#F5EDD8", fontFamily:"'Cormorant Garamond',serif", position:"relative", overflowX:"hidden" }}>
      ...
      <section style={{ position:"relative", zIndex:1, padding:"4rem 2rem", maxWidth:900, margin:"0 auto" }}>
        ...
        <div style={{ display:"flex", flexDirection:"column", alignItems:"center" }}>
          ...
          <div style={{ textAlign:"center", maxWidth:480 }}>
            <div style={{ fontFamily:"'Cinzel Decorative',serif", fontSize:"1.1rem", color:"#D4AF37", marginBottom:"0.6rem" }}>Kappa Gamma Eta</div>
            <p style={{ fontStyle:"italic", fontSize:"0.95rem", color:"rgba(245,237,216,0.5)", lineHeight:1.8 }}>The official crest of Kappa Gamma Eta — worn with pride by every sister as a mark of belonging, honour, and sisterhood.</p>
          </div>
        </div>
      </section>
      ...
      <section style={{ position:"relative", zIndex:1, padding:"4rem 2rem", maxWidth:900, margin:"0 auto" }}>
        <div style={{ textAlign:"center", marginBottom:"3rem" }}>
          ...
          <h2 style={{ fontFamily:"'Cinzel Decorative',serif", fontSize:"2rem", color:"#F5EDD8" }}>The Symbols</h2>
          <div style={{ height:1, width:60, background:"linear-gradient(90deg,transparent,#D4AF37,transparent)", margin:"0.8rem auto 0" }} />
        </div>
        <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:"1.5rem" }}>
          {[
            ...
            <div key={s.name} style={{ background:"#120709", border:"1px solid rgba(212,175,55,0.14)", padding:"2rem 1.5rem", textAlign:"center", position:"relative", overflow:"hidden" }}>
              ...
              <div style={{ fontSize:"2.5rem", marginBottom:"0.6rem" }}>{s.icon}</div>
              <div style={{ fontFamily:"'Cinzel Decorative',serif", fontSize:"0.85rem", color:"#D4AF37", marginBottom:"0.3rem", lineHeight:1.3 }}>{s.name}</div>
              <div style={{ fontFamily:"'Cinzel',serif", fontSize:"0.44rem", letterSpacing:"0.14em", textTransform:"uppercase", color:"rgba(212,175,55,0.4)", marginBottom:"0.8rem" }}>{s.role}</div>
              <div style={{ height:1, background:"rgba(212,175,55,0.1)", marginBottom:"0.8rem" }} />
              <p style={{ fontSize:"0.85rem", color:"rgba(245,237,216,0.55)", lineHeight:1.8 }}>{s.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* III — The Goddess */}
      <section style={{ position:"relative", zIndex:1, background:"rgba(123,3,35,0.07)", borderTop:"1px solid rgba(123,3,35,0.18)", borderBottom:"1px solid rgba(123,3,35,0.18)", padding:"5rem 2rem" }}>
        <div style={{ maxWidth:700, margin:"0 auto", textAlign:"center" }}>
          ...
          <h2 style={{ fontFamily:"'Cinzel Decorative',serif", fontSize:"2rem", color:"#F5EDD8", marginBottom:"0.5rem" }}>The Muse</h2>
          <div style={{ fontFamily:"'Cinzel',serif", fontSize:"0.6rem", letterSpacing:"0.2em", textTransform:"uppercase", color:"rgba(212,175,55,0.5)", marginBottom:"1.5rem" }}>Goddess Amphictyonis</div>
          <div style={{ height:1, width:60, background:"linear-gradient(90deg,transparent,#D4AF37,transparent)", margin:"0 auto 1.8rem" }} />
          <div style={{ background:"rgba(212,175,55,0.04)", border:"1px solid rgba(212,175,55,0.15)", padding:"2.5rem", position:"relative" }}>
            <CornerAccents />
            <p style={{ fontSize:"1.05rem", color:"rgba(245,237,216,0.7)", lineHeight:2 }}>
              The founders of Kappa Gamma Eta drew inspiration from <em>Amphictyonis</em> — the ancient Greek goddess of Wine, mutual respect, unity, and harmony among people. As a protector of alliances, she encouraged individuals and groups to come together in the spirit of cooperation, friendship, and shared strength.
            </p>
            <div style={{ height:1, background:"rgba(212,175,55,0.12)", margin:"1.5rem 0" }} />
            <p style={{ fontSize:"1rem", fontStyle:"italic", color:"rgba(245,237,216,0.5)", lineHeight:1.8 }}>
              Her spirit lives in the core of Kappa Gamma Eta — in every meeting, every bond formed, and every sister welcomed into the fold.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ position:"relative", zIndex:1, padding:"4rem 2rem", maxWidth:900, margin:"0 auto" }}>
        ...
        <div style={{ textAlign:"center", marginBottom:"3rem" }}>
          <div style={{ fontFamily:"'Cinzel Decorative',serif", fontSize:"clamp(4rem,14vw,9rem)", letterSpacing:"0.3em", lineHeight:1, background:"linear-gradient(135deg,#9A7B1A 0%,#D4AF37 30%,#fff8a0 50%,#D4AF37 70%,#9A7B1A 100%)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent", backgroundClip:"text", marginBottom:"0.5rem" }}>ΚΓΗ</div>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:"1.5rem" }}>
          {[
            { letter:"Κ", name:"Kappa",  text:"The beginning. The foundation upon which every great sisterhood is built. Kappa represents the courage to start something that matters." },
            { letter:"Γ", name:"Gamma",  text:"The bridge. The connection between sisters, between values, between who we are and who we aspire to be. Gamma is the bond." },
            { letter:"Η", name:"Eta",    text:"The completion. The promise fulfilled. Eta represents the whole woman — refined, empowered, and firmly rooted in her sisterhood." },
          ].map(l=>(
            <div key={l.letter} style={{ background:"#120709", border:"1px solid rgba(212,175,55,0.14)", padding:"2rem 1.5rem", textAlign:"center", position:"relative", overflow:"hidden" }}>
              ...
              <p style={{ fontSize:"0.85rem", color:"rgba(245,237,216,0.5)", lineHeight:1.8 }}>{l.text}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section style={{ position:"relative", zIndex:1, padding:"4rem 2rem", maxWidth:900, margin:"0 auto" }}>
        <div style={{ textAlign:"center", marginBottom:"3rem" }}>
          <div style={{ fontFamily:"'Cinzel',serif", fontSize:"0.5rem", letterSpacing:"0.3em", textTransform:"uppercase", color:"rgba(212,175,55,0.5)", marginBottom:"0.5rem" }}>V</div>
          <h2 style={{ fontFamily:"'Cinzel Decorative',serif", fontSize:"2rem", color:"#F5EDD8" }}>The Official Colours</h2>
          <div style={{ height:1, width:60, background:"linear-gradient(90deg,transparent,#D4AF37,transparent)", margin:"0.8rem auto 0" }} />
        </div>
        <div style={{ display:"grid", gridTemplateColumns:"repeat(2,1fr)", gap:"1.5rem" }}>
          {COLOURS.map(col=>(
            <div key={col.name} style={{ display:"flex", gap:"1.5rem", alignItems:"center", background:"#120709", border:"1px solid rgba(212,175,55,0.12)", padding:"1.5rem", overflow:"hidden" }}>
      ...
      <section style={{ position:"relative", zIndex:1, padding:"4rem 2rem 6rem", textAlign:"center" }}>
        ...
        <div style={{ position:"relative", maxWidth:700, margin:"0 auto" }}>
          <div style={{ fontFamily:"'Cinzel',serif", fontSize:"0.5rem", letterSpacing:"0.3em", textTransform:"uppercase", color:"rgba(212,175,55,0.5)", marginBottom:"0.5rem" }}>VI</div>
          ...
          <div style={{ background:"rgba(212,175,55,0.04)", border:"1px solid rgba(212,175,55,0.18)", padding:"3rem 2.5rem", position:"relative" }}>
            <CornerAccents />
            <div style={{ fontStyle:"italic", fontSize:"clamp(1.3rem,3vw,1.9rem)", color:"#F5EDD8", lineHeight:1.6, marginBottom:"1.2rem" }}>
